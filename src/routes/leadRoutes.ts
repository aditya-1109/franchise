...
import { sendPaymentLink, sendDigitalContract, sendFranchiseLoginCredentials } from '../controllers/leadController';
 ...
 *         description: Internal server error
 */
router.post('/send-digital-contract', sendDigitalContract);
 ...
 *         description: Internal server error
 */
router.post('/send-franchise-login', sendFranchiseLoginCredentials);
